// api/admin/edit-user.js - Edit user details for ClaudeSim
...
export default async function handler(req, res) {
  ...
  const { userId, name, email, organization, plan, experienceLevel, isAdmin, simulationsLimit } = req.body;
  ...
  try {
    const result = await sql`
      UPDATE users SET
        ...
        simulations_limit = COALESCE(${simulationsLimit || null}, simulations_limit),
